...
SPLIT = {
    ...
    "val": [2025],
    # оба тестовых года СЛЕПЫЕ: ни один не участвует ни в обучении, ни в
    # выборе чекпойнта (val 2025), ни в выборе конфигураций (грид — по val)
    "test": [2019],            # спокойный год, минимум солнечного цикла
    "test_hard": [2024],       # много бурь, максимум солнечного цикла
}
